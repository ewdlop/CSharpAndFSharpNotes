...
# 246 "SqlParser.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            let _1 = parseState.GetInput(1) :?> Sql.sqlStatement in
...
# 255 "SqlParser.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            let _2 = parseState.GetInput(2) :?> 'gentype_columnList in
            let _4 = parseState.GetInput(4) :?> string in
            let _5 = parseState.GetInput(5) :?> 'gentype_joinList in
            let _6 = parseState.GetInput(6) :?> 'gentype_whereClause in
            let _7 = parseState.GetInput(7) :?> 'gentype_orderByClause in
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 28 "SQL\SqlParser.fsy"
